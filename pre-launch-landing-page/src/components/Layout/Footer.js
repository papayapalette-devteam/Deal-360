...
<footer
  ...
  style={{
    backgroundImage: `url("/footerimage.jpg")`, // <- use url()
...
>
      <div className="w-full mx-auto px-5 sm:px-10 lg:px-16 xl:px-[192px] py-10 sm:py-12 lg:py-[51px]">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 lg:gap-4 mb-10 lg:mb-[57px]">
