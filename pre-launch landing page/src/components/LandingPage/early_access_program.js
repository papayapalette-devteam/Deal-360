// Deal 360 Early Access Program - Section 09
...
export default function EarlyAccessProgram() {
  return (
    <div className="font-poppins bg-white min-h-screen overflow-x-hidden pb-4">

      {/* ===== HEADER SECTION ===== */}
      <div className="px-6 sm:px-10 lg:px-16 xl:px-32 pt-12 lg:pt-16 pb-6 text-center">

        {/* Title */}
        <h1 className="text-[28px] sm:text-4xl lg:text-5xl xl:text-[64px] font-medium leading-[1.1] tracking-[-0.05em]">
          <span className="text-[var(--color-text)]">Join the </span>
          <span className="text-[#F88379]">Deal 360</span>
          <span className="text-[var(--color-text)]"> Early Access Program.</span>
        </h1>

        {/* Subtitle */}
        <p className="mt-5 lg:mt-6 text-sm sm:text-base lg:text-xl  text-[var(--color-text)] leading-[150%] max-w-[752px] mx-auto">
        ...
        {/* Description */}
        <p className="mt-5 lg:mt-7 text-sm sm:text-base lg:text-xl  text-[var(--color-text)] leading-[150%] max-w-[1339px] mx-auto">
          Deal 360 is not a lead portal. It is a transparent property platform built around verified listings, real intent, and better decision-making.
        </p>
        ...
        <div className="hidden lg:flex items-center justify-center gap-6 mt-10 flex-wrap">
          <button className="flex items-center gap-2 px-8 h-[52px] rounded-lg bg-[#7FFFD4] shadow-[0_0_2px_0_rgba(0,0,0,0.35),0_0_10px_0_rgba(255,255,255,0.25)_inset] text-[var(--color-text)] text-base font-semibold">
            <LogOutIcon />
            Pre - Registration
          </button>
      ...
      <div className="relative rounded-b-[30px] lg:rounded-b-none lg:rounded-t-[50px] overflow-hidden mt-8 lg:mt-0">
        ...
        {/* Background image */}
        <img
          src="https://api.builder.io/api/v1/image/assets/TEMP/5c7dcab31b945c33aacefa0f82413eb47227f3eb?width=3840"
          alt="Dubai skyline"
        ...
        <div className="relative z-20">
          ...
          <div className="lg:hidden px-0 pt-6 pb-12">
            ...
            <div className="flex flex-col items-center mb-6 px-6">
              <p className="text-[var(--color-text)] font-bold text-base leading-[26px]">Register Now!</p>
              <button className="mt-2 flex items-center gap-2 w-[191px] h-[52px] rounded-lg bg-[#7FFFD4] shadow-[0_0_2px_0_rgba(0,0,0,0.35),0_0_10px_0_rgba(255,255,255,0.25)_inset] text-[var(--color-text)] text-sm font-semibold justify-center">
                <LogOutIcon />
                Pre - Registration
              </button>
            </div>
            ...
            <div className="flex flex-col gap-4 overflow-hidden">
              ...
              <div className="ml-[18%] rounded-tl-xl rounded-bl-xl rounded-tr-none rounded-br-none bg-[#7FFFD4] py-6 px-6 flex flex-col items-center text-center">
                ...
                <h3 className="text-[var(--color-text)] text-2xl font-medium leading-8 mb-2">No payment upfront</h3>
                <p className="text-[var(--color-text)] text-xs leading-4">
                  No payment is taken upfront during registration. Billing begins only once the
                  platform is live and the account is activated on a paid plan.
                </p>
              </div>

              {/* Card 2: Limited & verified — LEFT EDGE (rounded right corners, extends left) */}
              <div className="-ml-5 rounded-tr-xl rounded-br-xl rounded-tl-none rounded-bl-none bg-[#F88379] py-6 px-6 flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full bg-white shadow flex items-center justify-center mb-4">
                  <ShieldIcon />
                </div>
                <h3 className="text-white text-2xl font-medium leading-8 mb-2">Limited & verified</h3>
                <p className="text-white text-xs leading-4">
                  Early registration availability is limited and subject to verification. We are onboarding a
                  select group of verified professionals first.
                </p>
              </div>
              ...
              <div className="ml-[18%] rounded-tl-xl rounded-bl-xl rounded-tr-none rounded-br-none bg-white py-5 px-6">
                <h3 className="text-[var(--color-text)] text-2xl font-medium leading-8 mb-2 text-center">
                  What Early Access<br />Means
                </h3>
                <p className="text-[var(--color-text)] text-xs leading-4 text-center mb-4">
                  Early registration allows agents and brokerages
                  to join Deal 360 ahead of public release and
                  secure preferential rates, valid for 12 months
                  from activation.
                </p>
              ...
              <div className="-ml-1 rounded-tr-xl rounded-br-xl rounded-tl-none rounded-bl-none bg-[#7FFFD4] py-6 px-6 flex flex-col items-center text-center">
                <div className="w-12 h-12 rounded-full bg-white shadow flex items-center justify-center mb-4">
                  <SparkleIcon />
                </div>
                <h3 className="text-[var(--color-text)] text-2xl font-medium leading-8 mb-2">Shape the platform</h3>
                <p className="text-[var(--color-text)] text-xs leading-4">
                  Your feedback directly influences features and
                  improvements. Early access to platform
              ...
              <div className="ml-[18%] rounded-tl-xl rounded-bl-xl rounded-tr-none rounded-br-none bg-white py-5 px-6 mb-4">
                <h3 className="text-[var(--color-text)] text-2xl font-medium leading-8 mb-2 text-center">Why It Matters</h3>
                <p className="text-[var(--color-text)] text-xs leading-4 text-center mb-4">
                  Not everyone will get the same access.
                  Establishing your presence early means better
                  positioning when the platform goes public.
                </p>
                <div className="flex flex-col gap-3">
          ...
          <div className="hidden lg:block px-6 xl:px-[10.6%] pt-20 pb-16">
            <div className="flex gap-6">
              ...
              <div className="flex flex-col gap-6 flex-[49]">
                ...
                <div className="flex gap-6">
                  ...
                  <div className="flex-1 h-[280px] rounded-2xl bg-[#7FFFD4] shadow-[0_0_10px_0_rgba(0,0,0,0.10)] flex flex-col items-center justify-center px-6 text-center">
                    ...
                    <h3 className="mt-5 text-[var(--color-text)] text-2xl font-medium leading-[122%]">No payment upfront</h3>
                  ...
                  <div className="flex-1 h-[280px] rounded-2xl bg-[#F88379] shadow-[0_0_10px_0_rgba(0,0,0,0.10)] opacity-90 flex flex-col items-center justify-center px-6 text-center">
                    ...
                    <h3 className="mt-5 text-white text-2xl font-medium leading-[122%]">Limited & verified</h3>
                ...
                <div className="h-[430px] rounded-2xl border border-[#B6B6B6] bg-white overflow-hidden px-10 py-10 flex flex-col">
                  <h3 className="text-[var(--color-text)] text-2xl font-medium leading-[110%]">What Early Access Means</h3>
                  <p className="mt-4 text-[var(--color-text)] text-sm leading-[150%] max-w-[574px]">
                    Early registration allows agents and brokerages to join Deal 360 ahead of public release and secure preferential early-registration rates, fixed for 12 months from activation.
                  </p>
              ...
              <div className="flex flex-col gap-6 flex-[51]">
                ...
                {/* Why It Matters */}
                <div className="h-[430px] rounded-2xl border border-[#B6B6B6] bg-white overflow-hidden px-10 py-10 flex flex-col">
                  <h3 className="text-[var(--color-text)] text-2xl font-medium leading-[110%]">Why It Matters</h3>
                ...
                <div className="h-[280px] rounded-2xl bg-[#7FFFD4] shadow-[0_0_10px_0_rgba(0,0,0,0.10)] flex flex-col items-center justify-center px-10 text-center">
                  ...
                  <h3 className="mt-5 text-[var(--color-text)] text-2xl font-medium leading-[110%]">Shape the platform</h3>
