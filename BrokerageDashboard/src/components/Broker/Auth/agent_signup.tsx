...
<div className="w-full md:w-1/2 min-h-screen overflow-hidden">
  ...
  />
      ...
      <div className="w-full  md:w-1/2 flex items-top justify-center px-5 py-10 md:py-16 bg-[#F8F9FA]">
        <div className="w-full max-w-[40.875rem] bg-white rounded-lg shadow-[0_4px_6px_0_rgba(0,0,0,0.06)] p-6">
...
<div className="flex flex-col gap-4">
  ...
  <div className="grid grid-cols-2 gap-3">
    ...
    <button
      type="button"
      className="h-12 rounded-lg border border-[hsl(var(--brand-neutral))] bg-[hsl(var(--brand-secondary))] text-white 
    ...
    <button
      type="button"
      className="h-12 rounded-lg border border-[hsl(var(--brand-neutral))] bg-[var(--brand-secondary1)] text-[var(--Colors-for-white-theme-Secondary)]  
                 transition-colors font-medium"
    >
      Brokerage
    </button>
              ...
              <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-10 w-full">
                  ...
                  <div className="flex flex-col gap-4 w-full">
                    ...
                    {/* rera orn */}
                    <FormInput
                      label="RERA BRN (Broker Registration Number)"
                      placeholder="BRN -XXXXXX"
                      type="text"
                      value={brn}
                      onChange={(e: any) => setBrn(e.target.value)}
                    />
