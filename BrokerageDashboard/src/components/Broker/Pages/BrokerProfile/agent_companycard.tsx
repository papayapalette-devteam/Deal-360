...
export default function AgentCompanyCard() {
  return (
    <div className="flex flex-col rounded-[0.625rem] border border-black/10 bg-white shadow-[3px_4px_8px_3px_rgba(158,158,158,0.25)] overflow-hidden min-w-[17.5rem] max-w-[24.25rem] w-full">
      {/* Logo area */}
      <div className="flex items-center justify-center p-6 flex-1">
        <img
          ...
          className="w-full max-w-[17.5rem] object-contain"
        />
      </div>

      {/* Company name footer */}
      <div className="border-t border-black/10 px-4 py-3 flex items-center justify-between">
        <span className="font-poppins text-[0.875rem] font-medium leading-[120%] text-[#343A40]">
