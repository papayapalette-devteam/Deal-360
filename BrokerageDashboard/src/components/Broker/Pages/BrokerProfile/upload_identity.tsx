        ...
        <div className="flex flex-col  gap-10 w-full w-full">
          ...
          <div className="flex flex-col sm:flex-row items-stretch gap-6 w-full">
            ...
            <div
              ...
              className="flex-1 flex flex-col justify-center items-center gap-[0.625rem] cursor-pointer"
              style={{
                padding: '1.5rem',
        ...
        <div className="flex flex-col justify-center gap-6 p-6 rounded-[0.875rem] border-2 border-[#D1D5DC] bg-white w-full">
          ...
          <div className="flex flex-col items-center gap-6 w-full">
            ...
            <div className="flex flex-col items-center gap-4 w-full">
              ...
              <div className="flex flex-col items-center gap-2 w-full">
                <h2
                  className="font-poppins text-[1.125rem] font-bold text-center"
                ...
                <p
                  className="font-poppins text-[0.875rem] text-center"
