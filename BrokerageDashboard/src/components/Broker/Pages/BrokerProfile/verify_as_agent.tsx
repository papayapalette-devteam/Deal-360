                  ...
                  <div className="flex flex-col gap-6 flex-1 min-w-0">
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <div className="flex items-center justify-center px-2 py-0.5 rounded-lg overflow-hidden" style={{ border: "1px solid #C0C3C1", background: "#FFF", height: '1.375rem' }}>
            ...
            >
              ...
              <div className="flex flex-col flex-1 gap-4 mt-4 justify-between">
                <div className="flex items-start gap-4">
                  ...
                  <div
                    className="flex-shrink-0 flex items-start justify-center rounded-xl pt-3 px-3"
                    style={{ width: '3.25rem', height: '3.25rem', background: "var(--form-primary)" }}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                  ...
                  <div className="flex flex-col gap-6 flex-1 min-w-0">
                    ...
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <div className="flex items-center justify-center px-2 py-0.5 rounded overflow-hidden" style={{ border: "1px solid #F88379", background: "#F9D6D4", height: '1.5rem' }}>
