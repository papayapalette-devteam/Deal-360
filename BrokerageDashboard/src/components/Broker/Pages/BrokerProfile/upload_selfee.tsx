    ...
    return (
        <div className="min-h-screen flex justify-center px-4 py-0">
            <div className="flex flex-col gap-10 w-full">
                ...
                {/* Upload Section */}
                <div className="flex flex-col justify-center gap-6 p-6 rounded-[0.875rem] border-2 border-[#D1D5DC] bg-white w-full">
                    <div className="flex flex-col items-center gap-6 w-full">
                        ...
                        <div className="flex flex-col items-center gap-4 w-full">
                            ...
                            <div className="flex flex-col items-center gap-2 w-full">
                                <h2 className="font-poppins text-[1.125rem] font-bold text-center" style={{ color: "var(--base-black)" }}>
                                    Upload Selfie
                                </h2>
                                <p className="font-poppins text-[0.875rem] text-center" style={{ color: "var(--text-grey)" }}>
                        ...
                        <div className="flex gap-2 mt-4">
                            {!selfiePreview ? (
                                ...
                                <label onClick={capture}
                                    className="flex items-center gap-2 px-4 rounded-[0.5rem] h-10 cursor-pointer"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <path d="M8 10.6641C9.10457 10.6641 10 9.76863 10 8.66406C10 7.55949 9.10457 6.66406 8 6.66406C6.89543 6.66406 6 7.55949 6 8.66406C6 9.76863 6.89543 10.6641 8 10.6641Z"
                                            stroke="black" stroke-width="1.33333" stroke-linecap="round"
                                            stroke-linejoin="round" /> </svg> <span className="font-poppins text-[0.875rem]"
                                ...
                                <>
                                    ...
                                    <label onClick={()=>setsubmission(true)}
                                        className="flex items-center gap-2 px-4 rounded-[0.5rem] h-10 cursor-pointer"
                                        style={{ backgroundColor: "var(--form-secondary)" }} >
                                        <span className="font-poppins text-[0.875rem]"
                                            style={{ color: "var(--form-text-black)" }} >
                                            Next
                                        </span>
                                    </label>
