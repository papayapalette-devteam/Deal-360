...
function VerificationItem({ icon, title, description }) {
  return (
    <div className="flex items-center justify-between w-full px-6 py-5 rounded-[0.625rem] border border-[#E5E7EB] dark:border-gray-700 bg-white dark:bg-gray-900">
      <div className="flex items-center gap-3">
        {/* Icon container */}
        <div className="flex-shrink-0 w-9 h-9 rounded-[0.625rem] bg-[#E6E7E6] dark:bg-gray-700 flex items-center justify-center">
          {icon}
        </div>
...
const items = [
  ...
  return (
    <div className="min-h-screen bg-[var(--form-bg)] dark:bg-gray-950 flex flex-col font-poppins">
      ...
      <main className="flex-1 w-full max-w-[96.25rem] mx-auto px-0 sm:px-0 py-6 flex flex-col gap-6">
        {/* Verification Required banner */}
          <div className="w-full bg-white dark:bg-gray-900 rounded-[0.625rem] border border-black/10 dark:border-gray-700 px-6 py-6">
      <div className="flex items-start gap-4">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2 flex-wrap">
            <h1 className="font-poppins font-semibold text-2xl md:text-[1.75rem] text-[var(--base-black)] dark:text-gray-100 leading-tight">
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="flex flex-col gap-6 w-full lg:flex-1 min-w-0">
             ...
             <div className="w-full bg-white dark:bg-gray-900 rounded-[0.875rem] border border-black/10 dark:border-gray-700 p-6">
      <div className="flex flex-col gap-10">
        {/* Card header */}
        <div className="flex items-start gap-4">
          {/* Briefcase icon box */}
          <div className="flex-shrink-0 w-[3.25rem] h-[3.25rem] rounded-[0.625rem] bg-[#FFFAFA] dark:bg-gray-800 flex items-end justify-center pt-3">
   ...
   <div className="w-full rounded-[0.875rem] border border-[#F88379] bg-[#FFF9F9] dark:bg-red-950/20 p-6">
      <div className="flex items-start gap-4">
        {/* Shield icon */}
        <svg
          width="20"
        ...
        <div className="flex flex-col gap-2">
          ...
          {/* Right sidebar */}
          <div className="flex flex-col gap-6 w-full lg:w-[23.75rem] xl:w-[26.5rem] flex-shrink-0">
          
              <div className="w-full bg-white dark:bg-gray-900 rounded-[0.875rem] p-6 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div
      className="w-full rounded-[0.875rem] p-6 flex flex-col gap-8"
