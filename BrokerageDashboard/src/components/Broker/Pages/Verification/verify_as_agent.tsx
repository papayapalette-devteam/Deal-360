...
export default function VerifyAsAgent() {
      ...
      <div className="flex flex-col flex-1 gap-4 mt-4 justify-between">
        <div className="flex items-start gap-4">
          ...
          <div
            ...
            style={{ width: '3.25rem', height: '3.25rem', background: "#F88379" }}
          >
          ...
          <div className="flex flex-col gap-6 flex-1 min-w-0">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="flex items-center justify-center px-2 py-0.5 rounded-lg overflow-hidden" style={{ border: "1px solid #8EC5FF", background: "#FFF", height: '1.375rem' }}>
    ...
    >
      ...
      <div className="flex flex-col flex-1 gap-4 mt-4 justify-between">
        <div className="flex items-start gap-4">
          ...
          <div
            className="flex-shrink-0 flex items-start justify-center rounded-xl pt-3 px-3"
            style={{ width: '3.25rem', height: '3.25rem', background: "#F3F4F6" }}
          >
            <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col gap-6 flex-1 min-w-0">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="flex items-center justify-center px-2 py-0.5 rounded overflow-hidden" style={{ border: "1px solid #AFB3B0", background: "#FFF", height: '1.5rem' }}>
  ...
  <div className="flex items-start gap-4 rounded-xl p-4 w-full" style={{ border: "1px solid #E5E7EB", background: "#F9FAFB" }}>
    <div className="flex-shrink-0 flex items-center justify-center rounded-full mt-0.5" style={{ width: '1.625rem', height: '1.625rem', border: "1.667px solid #4A5565" }}>
      <span>i</span>
    </div>
