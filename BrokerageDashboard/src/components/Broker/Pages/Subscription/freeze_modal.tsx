      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <h2
            ...
            style={{ fontSize: '1.5rem', lineHeight: "110%" }}
          >
            Freeze Your Subscription
          </h2>
          <p
            className="font-poppins font-bold text-black"
            style={{ fontSize: '1rem', lineHeight: "110%" }}
          >
        ...
        <p
          ...
          style={{ fontSize: '0.75rem', color: "#575757", lineHeight: "110%" }}
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            ...
            style={{ width: '3rem', height: '3rem', background: "#B4FFE6", padding: '0.75rem' }}
          >
            <SnowflakeIcon />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p
              ...
              style={{ fontSize: '0.75rem', color: "#A5A5A5", lineHeight: "110%" }}
            >
              AED {fullPrice}
            </p>
          </div>
          ...
          <div className="relative">
            ...
            >
              <span
                ...
                style={{ fontSize: '1rem', color: "#4B4B4B", lineHeight: "110%" }}
              >
                {displayDate}
              </span>
              <ChevronDown />
        ...
        <button
          ...
          style={{ padding: '1rem 2rem', fontSize: '1rem', lineHeight: "120%" }}
        >
          Confirm Freeze
        </button>
      </div>
