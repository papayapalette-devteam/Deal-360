...
function StatCard({ stat }) {
  return (
    <div className="bg-card rounded-[0.625rem] border border-[#E5E7EB] shadow-sm p-6 flex flex-col gap-6">
      <div
        className="w-12 h-12 rounded-[0.625rem] flex items-center justify-center flex-shrink-0"
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-[1.125rem] font-normal leading-[120%] text-[#4A5565]">
          {stat.label}
        </p>
      </div>
    </div>
  ...
  return (
    <div className=" bg-background p-2 sm:p-2 lg:p-2 font-sans">
      ...
      <div className="flex flex-col xl:flex-row gap-6 mb-6">
        ...
        <div className="flex-1 min-w-0 bg-card rounded-[0.875rem] border border-[#E5E7EB] shadow-sm p-6 pb-1">
          <h2 className="text-[1.125rem] font-medium text-[var(--secondary-text)] leading-[120%] mb-4">
            Daily Active Users
          </h2>
          <LineChart />
        </div>
        ...
        {/* Critical Alerts */}
        <div className="xl:w-[29.75rem] xl:flex-shrink-0 bg-card rounded-[0.875rem] border border-[#E5E7EB] shadow-sm p-6 pb-1">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-[1.125rem] font-medium text-[var(--secondary-text)] leading-[120%]">
              Critical Alerts
            </h2>
          </div>
          <div className="flex flex-col gap-3">
            {alertsData.map((alert, index) => (
              <div
                key={index}
                className="rounded-[0.625rem] px-3 py-2 flex flex-col gap-0"
                style={{
                  border: `0.07rem solid ${alert.borderColor}`,
                  background: alert.bg,
                }}
              >
                <p className="text-[0.875rem] font-medium text-[var(--secondary-text)] leading-[120%] m-0">
                  {alert.message}
                </p>
                <p className="text-[0.75rem] font-normal text-[#6A7282] leading-[120%] m-0">
                  {alert.time}
                </p>
              </div>
            ))}
      ...
      <div className="bg-card rounded-[0.875rem] border border-[#E5E7EB] shadow-sm p-6 pb-1">
        <h2 className="text-[1.125rem] font-medium text-[var(--secondary-text)] leading-[120%] mb-4">
