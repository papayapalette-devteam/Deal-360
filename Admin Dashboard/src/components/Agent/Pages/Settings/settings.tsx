...
function AccordionHeader({ icon, label, isOpen, onClick }) {
  return (
    <button
      onClick={onClick}
      className="flex w-full h-[60px] px-4 items-center justify-between rounded-md bg-card shadow-[0_4px_6px_0_rgba(0,0,0,0.10)] transition-shadow hover:shadow-[0_4px_10px_0_rgba(0,0,0,0.15)]"
    >
