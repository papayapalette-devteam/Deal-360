...
const handleDrop = (e) => {
  ...
  return (
    <div className="bg-card rounded-[0.75rem] border border-[#E6E7E6] overflow-hidden">
      <div className="bg-card dark:bg-[#1a2233] rounded-xl w-full max-w-4xl p-8 my-4">
        {/* Title + Type */}
        <div className="flex flex-col sm:flex-row gap-6 mb-6">
          <div className="flex-1 flex flex-col gap-2">
            ...
            <input
              ...
              className="h-[4.3125rem] px-3 py-2 border border-[#C0C3C1] dark:border-[#2e4060] rounded bg-card dark:bg-[#111827] text-[#8E938F] dark:text-[#5a6e84] font-manrope text-base outline-none focus:border-[#7FFFD4] transition-colors placeholder:text-[#8E938F]"
            />
          </div>
          <div className="flex-1 flex flex-col gap-2">
            <label className="text-base font-medium text-[var(--brand-dark)] font-manrope leading-[150%]">
    ...
    <p className="text-xs text-[#777B8A] font-manrope font-medium">
      or click to browse
        ...
        <div className="flex justify-end gap-6">
          <button
            onClick={onClose}
            className="flex-1 max-w-[13.625rem] h-12 flex items-center justify-center rounded-lg border border-[#F2415A] text-[#F2415A] font-poppins font-medium text-base hover:bg-[#F2415A]/5 transition-colors"
          >
            Cancel
          </button>
          <button className="flex-1 max-w-[13.625rem] h-12 flex items-center justify-center rounded-lg bg-[#7FFFD4] text-black font-poppins font-medium text-base hover:opacity-90 transition-opacity">
            Add
          </button>
        </div>
      </div>
