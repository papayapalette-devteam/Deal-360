...
function SearchFilterBar({ search, setSearch, statusFilter, setStatusFilter, roleFilter, setRoleFilter }) {
    return (
        <div className="bg-card rounded-[0.875rem] shadow-[0_4px_6px_-1px_rgba(0,0,0,0.10),0_2px_4px_-2px_rgba(0,0,0,0.10)] p-4 sm:p-6">
                ...
                <div className="flex gap-2 flex-shrink-0">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="appearance-none bg-[#F3F3F5] rounded-lg px-4 pr-9 py-2.5 text-sm font-[Poppins] text-foreground outline-none cursor-pointer min-w-[8.75rem] h-[2.5rem]"
                        >
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="appearance-none bg-[#F3F3F5] rounded-lg px-4 pr-9 py-2.5 text-sm font-[Poppins] text-foreground outline-none cursor-pointer min-w-[8.125rem] h-[2.5rem]"
                        >
...
function AdvertisementTable({ users,  setdelete_modal,setview_modal,setedit_modal}) {
    return (
        <div className="bg-card rounded-[0.75rem] border border-[#E6E7E6] overflow-hidden">
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 whitespace-nowrap">
                                        <div className="flex items-center justify-center gap-3">
                                            ...
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" viewBox="0 0 24 24" fill="none">
                                                    <path d="M9 3H15M3 6H21M19 6L18.2987 16.5193C18.1935 18.0975 18.1409 18.8867 17.8 19.485C17.4999 20.0118 17.0472 20.4353 16.5017 20.6997C15.882 21 15.0911 21 13.5093 21H10.4907C8.90891 21 8.11803 21 7.49834 20.6997C6.95276 20.4353 6.50009 20.0118 6.19998 19.485C5.85911 18.8867 5.8065 18.0975 5.70129 16.5193L5 6M10 10.5V15.5M14 10.5V15.5" stroke="#181818" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                            </button>
                                        </div>
                                    </td>
