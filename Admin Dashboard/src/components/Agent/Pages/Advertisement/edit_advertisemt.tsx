...
export default function EditModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
      <div
        className="flex flex-col justify-center items-center gap-4 bg-card dark:bg-[#1a2233] rounded-xl shadow-lg relative"
        style={{
          width: "56.625rem",
          height: "31.3125rem",
          padding: "2.5rem",
      ...
      >
        ...
        <div className="flex w-full gap-4">
          <div className="flex-1 flex flex-col gap-2">
            ...
            <input
              ...
              className="h-[2.75rem] px-3 py-2 border border-[#C0C3C1] dark:border-[#2e4060] rounded bg-card dark:bg-[#111827] text-[#8E938F] dark:text-[#5a6e84] font-manrope text-base outline-none focus:border-[#7FFFD4] transition-colors placeholder:text-[#8E938F]"
            />
          </div>
        ...
        <div className="flex justify-end gap-4 w-full mt-auto">
          <button
            onClick={onClose}
            className="flex-1 max-w-[13.625rem] h-12 flex items-center justify-center rounded-lg border border-[#F2415A] text-[#838383] font-poppins font-medium text-base bg-[#EAEAEA] transition-colors"
          >
            Back
          </button>
