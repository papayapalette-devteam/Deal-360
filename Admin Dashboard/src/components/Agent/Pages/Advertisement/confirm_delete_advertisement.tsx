...
export default function ConfirmDeleteAdvertisement({ onCancel }) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center p-4 bg-black/30 z-50">
            <div className="w-full max-w-[448px] bg-[var(--brand-white)] rounded-[14px] shadow-[0_20px_25px_-5px_rgba(0,0,0,0.10),0_8px_10px_-6px_rgba(0,0,0,0.10)] p-6 flex flex-col">
                ...
                <div className="flex w-12 h-12 items-center justify-center rounded-[28px] border-[8px] border-[#D3FFF0] bg-[#BAFFE8]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M11.9984 8.997V12.747M2.69536 16.123C1.82936 17.623 2.91236 19.497 4.64336 19.497H19.3534C21.0834 19.497 22.1664 17.623 21.3014 16.123L13.9474 3.375C13.0814 1.875 10.9154 1.875 10.0494 3.375L2.69536 16.123ZM11.9984 15.747H12.0054V15.755H11.9984V15.747Z" stroke="#999999" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </div>
                {/* Description */}
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <button
                        ...
                        className="flex-1 py-[12px] rounded-[10px] bg-[var(--form-secondary)] text-[var(--secondary-text1)] text-[14px] font-medium font-poppins hover:opacity-90 transition"
                    >
                        Confirm
                    </button>
                </div>
