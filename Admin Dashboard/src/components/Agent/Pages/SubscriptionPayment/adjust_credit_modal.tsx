...
export default function AdjustCreditsModal({ onClose, companyName = "Empire Realty Group", currentBalance = 250 }) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: "rgba(0,0,0,0.4)" }}>
      {/* Modal Card */}
      <div
        className="relative w-full max-w-[448px] flex flex-col gap-4 rounded-[14px] bg-card p-6"
      ...
      >
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          <select
            ...
            className="w-full h-[40px] px-3 rounded-[10px] text-[14px] outline-none focus:ring-2 bg-card appearance-none cursor-pointer"
            style={{
              fontFamily: "Poppins, sans-serif",
              border: "1.111px solid #D1D5DC",
