        ...
        <table className="w-full min-w-[700px]">
          <thead>
            <tr className="bg-[rgba(248,131,121,0.10)]">
              <th className="text-left px-6 py-3 text-base font-medium font-[Poppins] text-black rounded-tl-[0.75rem] whitespace-nowrap">
                User ID
              </th>
              ...
              <th className="text-center px-6 py-3 text-base font-medium font-[Poppins] text-black rounded-tr-[0.75rem] whitespace-nowrap">
                Actions
              </th>
            </tr>
          </thead>
