  ...
  return (
    <div className="flex flex-col items-start gap-2 w-full">
      {label && (
        <label
          htmlFor={id}
          className="text-[var(--gray-text)] font-semibold text-brand-grey font-manrope leading-[150%] truncate w-full"
        >
          {label}
        </label>
      )}
  ...
  return (
    <div className="flex flex-col items-start gap-2 w-full">
      {label && (
        <label
          htmlFor={id}
          className="text-[var(--gray-text)] font-medium text-brand-grey font-manrope leading-[150%]"
        >
          {label}
        </label>
      )}
