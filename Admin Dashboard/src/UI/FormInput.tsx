  ...
  return (
    <div className="flex flex-col items-start gap-2 w-full">
      {label && (
        <label
          htmlFor={id}
          className="text-[var(--gray-text)] font-semibold font-manrope leading-[150%] truncate w-full"
        >
          {label}
        </label>
      )}
...
export function PasswordInput({ label, placeholder, value, onChange, id }: PasswordInputProps) {
  ...
  return (
    <div className="flex flex-col items-start gap-2 w-full">
      {label && (
        <label
          htmlFor={id}
          className="text-[var(--gray-text)] font-medium font-manrope leading-[150%]"
        >
          {label}
        </label>
      )}
