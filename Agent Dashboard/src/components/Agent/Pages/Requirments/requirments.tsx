...
function ChevronIcon() {
  return (
    <svg style={{ width: "0.88rem", height: "0.88rem" }} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 opacity-50">
...
function LockIcon() {
  return (
    <svg style={{ width: "0.72rem", height: "0.72rem" }} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
      <path
...
function CreditsIcon() {
  return (
    <svg style={{ width: "0.77rem", height: "0.77rem" }} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0">
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center justify-between gap-[0.66rem] px-[0.66rem] h-[2rem] rounded-[0.44rem] font-arimo text-sm text-black min-w-[7.77rem] sm:min-w-[10rem]"
...
function BuyerCard({ buyer,setIsModalOpen }) {
  return (
    <div className="bg-white rounded-[0.88rem] p-[0.88rem] sm:p-[1.33rem] flex flex-col gap-[0.88rem] sm:gap-[1.33rem]">
      {/* Header */}
      <div className="flex items-center gap-2 sm:gap-3">
        <div
          className="w-[3.33rem] h-[3.33rem] sm:w-[3.88rem] sm:h-[3.88rem] rounded-full flex items-center justify-center flex-shrink-0"
      ...
      <div className="flex items-center gap-3">
        ...
        onClick={() => setIsModalOpen(true)}
          className="flex items-center gap-[0.22rem] px-[0.88rem] py-[0.38rem] rounded-[0.44rem] font-arimo text-sm text-black transition-opacity hover:opacity-90"
          style={{ backgroundColor: "var(--form-secondary)" }}
        >
          <LockIcon />
        ...
        {/* Credits badge */}
        <div
          className="flex items-center gap-[0.22rem] px-[0.72rem] py-[0.5rem] rounded-[0.44rem]"
...
export default function BuyerRequirements() {
  ...
  return (
    <div className="min-h-screen py-[1.33rem] px-[0.88rem] sm:px-[1.33rem] lg:px-[1.77rem]" style={{ backgroundColor: "hsl(var(--background))" }}>
      <div className="max-w-[77.94rem] mx-auto flex flex-col gap-[1.33rem]">
        ...
        <div className="flex flex-col gap-4 sm:gap-6">
          {filteredBuyers.length > 0 ? (
            ...
            <div className="bg-white rounded-[0.88rem] p-[2.22rem] text-center">
