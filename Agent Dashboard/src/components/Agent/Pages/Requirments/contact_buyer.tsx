    ...
    >
      <div className="w-full mx-auto flex flex-col gap-3">
        ...
        <button className="flex items-center gap-2 w-fit" style={{ color: "#4B4B4B" }}>
          <span
            className="flex items-center justify-center w-[1.33rem] h-[1.33rem] rounded-full"
        ...
        {/* Profile Card */}
        <div
          className="relative rounded-[0.55rem] overflow-hidden pb-6"
          style={{
            background: "#fff",
        ...
        >
          ...
          >
            <img
              ...
              alt="Olivia Rhye"
              style={{ width: "6.66rem", height: "6.66rem", borderRadius: "50%", objectFit: "cover", border: "0.22rem solid #F7F8F8" }}
            />
          </div>
          ...
          {/* User Info */}
          <div className="flex sm:ml-[9.33rem] flex-col gap-2 pt-4 pb-0 px-4 sm:px-0 ">
            <h1 className="text-2xl sm:text-[1.55rem] font-semibold leading-[120%]" style={{ color: "var(--base-black)" }}>
              Olivia Rhye
            </h1>
            ...
            <button
              ...
              style={{ background: "#7FFFD4", color: "#4B4B4B", height: "1.77rem" }}
            >
        ...
        <div
          className="rounded-[0.88rem] p-4 sm:p-6 flex flex-col gap-6"
          style={{ background: "#fff" }}
        >
          {/* Section Header */}
          <div className="flex items-center gap-2">
            <span
              className="flex items-center justify-center w-[1.33rem] h-[1.33rem] rounded-full flex-shrink-0"
              style={{ background: "#D9FFF2" }}
            >
              <svg style={{ width: "0.88rem", height: "0.88rem" }} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
