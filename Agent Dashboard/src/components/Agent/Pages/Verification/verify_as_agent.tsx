...
export default function VerifyAsAgent() {
        ...
        >
            <div className="w-full flex flex-col items-center gap-12">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    >
                        <svg style={{ width: "1.77rem", height: "1.77rem" }} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {/* Title & subtitle */}
                    <div className="flex flex-col items-center gap-[0.44rem]">
                        <h1
                            className="text-[1.33rem] font-medium text-center"
                            style={{ color: "var(--base-black)", lineHeight: "120%" }}
                        >
                            Verify as Agent
                        </h1>
                        <p
                            className="text-[0.88rem] text-center"
  ...
  <div className="flex flex-col lg:flex-row gap-6 w-full">
    ...
    <div
      className="relative flex flex-col rounded-[0.88rem] p-[1.33rem] flex-1 w-full min-w-0"
      style={{
    ...
    >
      ...
      <div className="flex flex-col flex-1 gap-4 mt-4 justify-between">
        <div className="flex items-start gap-4">
          {/* Icon */}
          <div
            className="flex-shrink-0 flex items-start justify-center rounded-[0.66rem] pt-[0.66rem] px-[0.66rem]"
            style={{ width: "2.88rem", height: "2.88rem", background: "#F88379" }}
          >
          ...
          <div className="flex flex-col gap-6 flex-1 min-w-0">
            ...
            <div className="flex flex-col gap-[0.44rem] flex-1 min-w-0">
              <div className="flex items-center gap-[0.44rem] flex-wrap">
                <span className="text-[1.11rem] font-medium" style={{ color: "var(--base-black)", lineHeight: "120%" }}>
                  UAE Pass Verification
                </span>
                <div className="flex items-center justify-center px-[0.44rem] py-[0.11rem] rounded-[0.44rem] overflow-hidden" style={{ border: "1px solid #8EC5FF", background: "#FFF", height: "1.22rem" }}>
                  <span className="text-[0.66rem] font-normal" style={{ color: "#1447E6" }}>Instant</span>
                </div>
              </div>
              <p className="text-[0.88rem] font-normal" style={{ color: "var(--text-grey)", lineHeight: "120%" }}>
        ...
        onClick={()=>navigate("upload")}
          className=" flex items-center gap-[0.44rem] rounded-[0.44rem] px-[0.88rem] py-[0.44rem] text-[0.77rem] font-normal transition-opacity hover:opacity-90 active:opacity-75 mt-[0.88rem]"
          style={{
            background: "#F88379",
    ...
    >
      ...
      <div className="flex flex-col flex-1 gap-4 mt-4 justify-between">
        <div className="flex items-start gap-4">
          ...
          <div
            className="flex-shrink-0 flex items-start justify-center rounded-[0.66rem] pt-[0.66rem] px-[0.66rem]"
            style={{ width: "2.88rem", height: "2.88rem", background: "#F3F4F6" }}
          >
            <svg style={{ width: "1.55rem", height: "1.55rem" }} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col gap-6 flex-1 min-w-0">
            ...
            <div className="flex flex-col gap-[0.44rem] flex-1 min-w-0">
              <div className="flex items-center gap-[0.44rem] flex-wrap">
                ...
                <div className="flex items-center justify-center px-[0.44rem] py-[0.11rem] rounded-[0.22rem] overflow-hidden" style={{ border: "1px solid #AFB3B0", background: "#FFF", height: "1.33rem" }}>
                  <span className="text-[0.66rem] font-normal" style={{ color: "#AFB3B0" }}>24-48 hours</span>
                </div>
              </div>
              <p className="text-[0.88rem] font-normal" style={{ color: "var(--text-grey)", lineHeight: "120%" }}>
  ...
  {/* Info box */}
  <div className="flex items-start gap-[0.88rem] rounded-[0.66rem] p-[0.88rem] w-full" style={{ border: "1px solid #E5E7EB", background: "#F9FAFB" }}>
    <div className="flex-shrink-0 flex items-center justify-center rounded-full mt-[0.11rem]" style={{ width: "1.44rem", height: "1.44rem", border: "1.667px solid #4A5565" }}>
      <span>i</span>
    </div>
...
function FeatureItem({ text, color }) {
    return (
        <div className="flex items-center gap-[0.44rem]">
            ...
            <span className="text-[0.77rem] font-normal" style={{ color: "var(--text-grey)", lineHeight: "120%" }}>
                {text}
            </span>
        </div>
    );
