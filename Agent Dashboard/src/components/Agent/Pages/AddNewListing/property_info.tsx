...
const LocationIcon = () => (
  <svg style={{ width: "1.33rem", height: "1.33rem", flexShrink: 0, color: "var(--form-icon)" }} viewBox="0 0 24 24" fill="none">
...
const InfoIcon = () => (
  <svg style={{ width: "0.88rem", height: "0.88rem", flexShrink: 0, color: "var(--form-text)" }} viewBox="0 0 16 16" fill="none">
...
const ChevronDown = () => (
  <svg style={{ width: "1.33rem", height: "1.33rem", flexShrink: 0, color: "var(--form-text)" }} viewBox="0 0 24 24" fill="none">
    <path d="M17 9.5L12 14.5L7 9.5H17Z" fill="currentColor" />
  </svg>
);

const CheckedBox = () => (
  <svg style={{ width: "0.88rem", height: "0.88rem", flexShrink: 0 }} viewBox="0 0 16 16" fill="none">
...
const UncheckedBox = () => (
  <div style={{ width: "0.88rem", height: "0.88rem", borderRadius: "0.22rem", border: "1px solid var(--form-checkbox-border)", flexShrink: 0 }} />
);
...
/* Property Type Icons */
const ApartmentIcon = () => (
  <svg style={{ width: "1.33rem", height: "1.33rem", color: "var(--form-icon)" }} viewBox="0 0 24 24" fill="none">
...
const BUAIcon = () => (
  <svg style={{ width: "1rem", height: "1rem", flexShrink: 0 }} viewBox="0 0 18 18" fill="none">
...
const PlotSizeIcon = () => (
  <svg style={{ width: "1rem", height: "1rem", flexShrink: 0 }} viewBox="0 0 18 18" fill="var(--form-primary)">
...
const CheckboxItem = ({ label, checked, onChange, small = false }) => (
  ...
  >
    ...
    <span style={{
      fontFamily: "'Poppins', sans-serif",
      fontSize: small ? "0.66rem" : "0.88rem",
      fontWeight: 400,
      color: "var(--form-text)",
    }}>
      {label}
...
export default function PropertyInfoForm() {
  ...
  const yesBtn = {
    ...
    fontSize: "0.88rem",
    fontFamily: "'Poppins', sans-serif",
    boxShadow: "0 0.22rem 0.22rem 0 rgba(0,0,0,0.25)",
    flexShrink: 0,
  };
  const noBtn = {
    display: "flex",
    ...
    fontSize: "0.88rem",
    fontFamily: "'Poppins', sans-serif",
    boxShadow: "0 0.22rem 0.22rem 0 rgba(153,149,149,0.24) inset",
    flexShrink: 0,
  };
  ...
  return (
    <div style={{
      ...
      <div className="flex flex-col lg:flex-row gap-[1.33rem]">
        {/* Location Column */}
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "0.66rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.44rem" }}>
            <LocationIcon />
            <span style={{ fontSize: "1.11rem", fontWeight: 500, color: "var(--form-text)" }}>Location *</span>
            <InfoIcon />
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.44rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.44rem" }}>
              <span style={{ fontSize: "0.77rem", fontWeight: 500, color: "var(--form-text)" }}>Ideal for *</span>
              <InfoIcon />
            </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "0.66rem" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.44rem" }}>
            <span style={{ fontSize: "1.11rem", fontWeight: 500, color: "var(--form-text)" }}>Expected Price (AED) *</span>
          </div>
          ...
          <div style={{ ...inputBoxStyle, flex: "unset" }}>
            <input
              ...
              style={inputStyle}
            />
            <span style={{ fontSize: "0.66rem", color: "var(--form-text)", flexShrink: 0 }}>Negotiable</span>
          ...
          {/* Deal Signals */}
          <div style={{ display: "flex", alignItems: "flex-start", gap: "0.66rem", flexWrap: "wrap" }}>
            <span style={{ fontSize: "0.77rem", fontWeight: 400, color: "var(--form-text)", flexShrink: 0 }}>Deals signals*</span>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "0.44rem", flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.66rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.44rem" }}>
              <span style={{ fontSize: "1.11rem", fontWeight: 500, color: "var(--form-text)" }}>4% DLD calculated*</span>
              <InfoIcon />
            </div>
            <div style={{ ...inputBoxStyle, flex: "unset" }}>
              <input
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.66rem" }}>
        ...
        <div className="flex gap-[0.88rem] flex-wrap sm:flex-nowrap">
      ...
      <div style={{
        ...
        <span style={{ flex: 1, fontSize: "0.66rem", fontWeight: 500, color: "var(--form-alert-text)", lineHeight: "140%" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.66rem" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: "0.88rem" }}>
          <div style={{
            display: "flex",
            padding: "0.66rem 1.33rem",
            alignItems: "center",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
        ...
        <div className="flex flex-col sm:flex-row gap-[0.88rem]">
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "0.44rem" }}>
      ...
      {/* ── AREA / PARKING ROW ── */}
      <div style={{ display: "flex", flexDirection: "column", gap: "0.44rem" }}>
        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-[0.88rem]">
          {/* BUA */}
          <div style={{ flex: 1, minWidth: "8.88rem", display: "flex", flexDirection: "column", gap: "0.66rem" }}>
          ...
          {/* Plot Size */}
          <div style={{ flex: 1, minWidth: "8.88rem", display: "flex", flexDirection: "column", gap: "0.44rem", justifyContent: "flex-end" }}>
      ...
      <div className="flex flex-col sm:flex-row gap-[1.33rem]">
        {/* Features */}
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "0.66rem" }}>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: "0.66rem" }}>
          ...
          <div style={{ ...inputBoxStyle }}>
            <SparkIcon />
            <span style={{ flex: 1, fontSize: "0.88rem", color: "var(--form-text)", fontFamily: "'Poppins', sans-serif" }}>{furnishing}</span>
            <ChevronDown />
          </div>
        </div>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.44rem" }}>
        ...
        <div className="flex flex-col sm:flex-row gap-[0.88rem]">
          <div style={{ flex: 1, display: "flex", alignItems: "center", gap: "0.88rem" }}>
            <div style={{ ...inputBoxStyle, flex: 1 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.66rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.55rem", padding: "0.66rem 0" }}>
          <span style={{ fontSize: "0.88rem", fontWeight: 500, color: "var(--form-text-black)", fontFamily: "'Poppins', sans-serif" }}>
          ...
          >
            <div style={{ width: "1.44rem", height: "1.44rem", borderRadius: "55.5rem", backgroundColor: "white", flexShrink: 0 }} />
          </button>
        </div>

        {/* Owner Details */}
        <div style={{ display: "flex", flexDirection: "column", gap: "0.66rem" }}>
          <span style={{ fontSize: "0.88rem", fontWeight: 500, color: "var(--form-text)", fontFamily: "'Poppins', sans-serif" }}>
            Owner Details
          </span>
