...
function PropertyChip({ icon, label }) {
  return (
    <div className="flex items-center gap-[0.22rem] px-[0.88rem] sm:px-[1.77rem] py-[0.66rem] sm:py-[0.88rem] rounded border border-[#E6E7E6] bg-[#F7F8F8] shrink-0">
      {icon}
      <span className="text-[#565656] font-poppins text-[0.55rem] text-center whitespace-nowrap">
        {label}
      </span>
    </div>
  );
...
function BedIcon() {
  return (
    <svg style={{ width: "1.33rem", height: "1.33rem" }} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function FurnishedIcon() {
  return (
    <svg style={{ width: "1.33rem", height: "1.33rem" }} viewBox="0 0 24 34" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function AmenityChip({ icon, label }) {
  return (
    <div className="flex items-center gap-[0.66rem] px-[0.88rem] py-[0.44rem] rounded-full border border-[#D8D8D8] shrink-0">
      <span className="flex-shrink-0">{icon}</span>
      <span className="text-[#68706A] font-poppins text-[0.77rem] sm:text-[0.88rem] capitalize whitespace-nowrap">
        {label}
      </span>
    </div>
  );
...
function VillaIcon() {
  return (
    <svg style={{ width: "2rem", height: "2rem" }} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function BedroomIcon() {
  return (
    <svg style={{ width: "2.22rem", height: "1.55rem" }} viewBox="0 0 40 28" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function BalconyFeatureIcon() {
  return (
    <svg style={{ width: "2rem", height: "2.22rem" }} viewBox="0 0 36 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function AcFeatureIcon() {
  return (
    <svg style={{ width: "2.22rem", height: "2.22rem" }} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function GardenIcon() {
  return (
    <svg style={{ width: "2.33rem", height: "2.22rem" }} viewBox="0 0 42 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function PoolIcon() {
  return (
    <svg style={{ width: "2.16rem", height: "2.16rem" }} viewBox="0 0 39 39" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function FeatureCard({ icon, label }) {
  return (
    <div className="flex-1 min-w-[6.66rem] h-[9.44rem] flex flex-col items-center justify-center gap-[0.44rem] rounded-[0.66rem] border border-[#DDD] bg-white shadow-[0_4px_4px_0_rgba(0,0,0,0.10)] px-[0.88rem] sm:px-[2.66rem] py-[1.77rem]">
      <div className="flex-shrink-0">{icon}</div>
      <span className="text-[#494949] font-poppins font-semibold text-sm sm:text-base text-center">
        {label}
      </span>
    </div>
  );
...
function TableCell({ label, isLabel }) {
  return (
    <div
      className={`flex items-center justify-center px-[0.88rem] sm:px-[1.33rem] py-[0.88rem] border-b border-[#E6E7E6] last:border-b-0 ${isLabel ? "font-medium text-[0.77rem] text-black" : "text-[#565656] text-[0.77rem] sm:text-[0.88rem]"
        } font-poppins`}
    >
      {label}
    </div>
...
export default function ReviewPublish() {
  ...
  return (
    <div className="flex flex-col gap-[1.33rem]">
      ...
      {/* image section */}
      {/* Main hero image */}
      <div className="relative rounded-[0.66rem] overflow-hidden h-[12.44rem] sm:h-[17.77rem] lg:h-[30rem]">
        <img
          src={mainSrc}
          alt="Property view"
        ...
        />
        {/* Carousel dots */}
        <div className="absolute bottom-[0.88rem] left-0 right-0 flex justify-center items-center gap-[0.66rem]">
          {Array.from({ length: DOT_COUNT }).map((_, i) => (
            <button
              key={i}
              onClick={() => setActiveIndex(i < IMAGES.length ? i : 0)}
              className="w-[0.88rem] h-[0.88rem] rounded-full transition-colors focus:outline-none"
              style={{
                backgroundColor:
                  i === activeIndex
                    ? "#F88379"
      ...
      {/* Thumbnail strip */}
      <div className="grid grid-cols-4 md:grid-cols-8 gap-[0.44rem] md:gap-[0.66rem]">
        {IMAGES.slice(0, 7).map((img, i) => (
          ...
          >
            <img
              src={img}
              alt={`View ${i + 1}`}
              className={`w-full aspect-[90/53] object-cover rounded-lg transition-all ${i === activeIndex
        ...
        >
          ...
          />
          <div className="absolute inset-0 rounded-[0.44rem] bg-black/40 flex items-center justify-center">
            <span className="text-[#F8F9FA] font-poppins font-semibold text-[0.77rem] sm:text-[0.88rem] text-center leading-tight">
              10+ More
              <br />
              Photos
            </span>
      ...
      <div className="flex flex-col gap-[1.33rem]">
        {/* Price */}
        <div className="flex items-baseline gap-[0.22rem] leading-tight">
          <span className="font-poppins font-medium text-[1.11rem] sm:text-[1.33rem] text-[#F88379]">
            AED
          </span>
          <span className="font-poppins font-semibold text-[1.66rem] sm:text-[2.22rem] lg:text-[3.11rem] text-[#F88379] leading-none">
            3,800,000
          </span>
        </div>
        ...
        <div className="flex flex-col gap-[1.33rem]">
          ...
          <div className="flex items-center gap-[0.22rem]">
            <LocationPinIcon />
            <span className="text-[#68706A] font-poppins text-[0.88rem]">
          ...
          {/* Status chips */}
          <div className="flex flex-col gap-[1.33rem]">
            <div className="flex flex-wrap items-center gap-[0.44rem]">
              {/* Available badge */}
              <div className="flex items-center gap-[0.22rem] px-[0.88rem] py-[0.33rem] rounded-[0.22rem] border border-[#F88379] bg-[#F88379]/10 shrink-0">
                <div className="w-[0.44rem] h-[0.44rem] rounded-full bg-[#F88379]" />
                <span className="text-[#F88379] font-poppins font-medium text-[0.88rem]">
                  Available
                </span>
              </div>
            ...
            {/* Title + Description */}
            <div className="flex flex-col gap-[1.33rem]">
              <h2 className="text-[#343A40] font-poppins font-medium text-[0.88rem]">
                Genuine Resale | End Unit | Luxurious
              </h2>
              <p className="text-[#68706A] font-poppins text-[0.77rem] leading-[120%] whitespace-pre-line">
                {DESCRIPTION}
              </p>
            </div>
          </div>
      ...
      <div className="rounded-[0.44rem] bg-white p-[0.88rem] border border-[#E6E7E6]">
        <div className="flex flex-col gap-[2.22rem] sm:gap-[3.33rem] rounded-[0.44rem]">
          {/* Heading */}
          <div className="flex flex-col gap-[0.22rem]">
            <h2 className="font-poppins font-medium text-[1.11rem] sm:text-[1.77rem] leading-[120%]">
              <span className="text-[#343A40]">Key </span>
              <span className="text-[#F88379]">Property Highlights</span>
            </h2>
            <p className="text-[#8E938F] font-poppins text-[0.77rem] leading-[120%]">
          ...
          <div className="flex flex-col gap-[1.33rem]">
            {/* Row 1 */}
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-[0.88rem] sm:gap-[1.33rem]">
              {HIGHLIGHTS.slice(0, 5).map(({ icon, label }, i) => (
                <div key={i} className="flex items-center gap-[0.22rem]">
                  {icon}
                  <span className="text-[#343A40] font-poppins text-[0.66rem] leading-[120%]">
                    {label}
                  </span>
                </div>
              ))}
        ...
        <div className="flex flex-col gap-[1.33rem] w-full mt-[0.88rem]">
          {/* Heading */}
          <div className="flex flex-col gap-[0.22rem]">
            <h2 className="font-poppins font-medium text-[1.11rem] sm:text-[1.77rem] leading-[120%]">
            ...
            <p className="text-[#8E938F] font-poppins text-[0.77rem] sm:text-[0.88rem] leading-[120%]">
          ...
          {/* Amenities */}
          <div className="flex flex-wrap gap-[0.88rem] sm:gap-[1.33rem] w-full">
      ...
      <div className="flex flex-col gap-[0.88rem]">
        {/* Title */}
        <h2 className="text-[#343A40] font-poppins font-medium text-[1.11rem] sm:text-[1.77rem] leading-[120%]">
        ...
        <div className="rounded-xl border border-[#E6E7E6] bg-white overflow-hidden">
          ...
          <div className="hidden sm:grid sm:grid-cols-4">
            ...
            <div className="flex flex-col">
              {LEFT_ROWS.map((row, i) => (
                <div
                  key={i}
                  className={`flex items-center justify-center px-[1.33rem] py-[1.22rem] ${i < LEFT_ROWS.length - 1 ? "border-b border-[#E6E7E6]" : ""
                    }`}
                >
                  <span className="font-poppins font-medium text-[0.77rem] text-black text-center">
                    {row.label}
                  </span>
                </div>
              ))}
            ...
            <div className="flex flex-col">
              {LEFT_ROWS.map((row, i) => (
                ...
                >
                  <span className="text-[#565656] font-poppins text-[0.88rem] text-center">
                    {row.value}
                  </span>
                </div>
              ))}
            ...
            <div className="flex flex-col border-l border-[#E6E7E6]">
              {RIGHT_ROWS.map((row, i) => (
                <div
                  key={i}
                  className={`flex items-center justify-center px-[1.33rem] py-[1.22rem] ${i < RIGHT_ROWS.length - 1 ? "border-b border-[#E6E7E6]" : ""
                    }`}
                >
                  <span className="text-[#565656] font-poppins text-[0.88rem] text-center">
                    {row.label}
          ...
          <div className="flex flex-col sm:hidden">
            {[...LEFT_ROWS, ...RIGHT_ROWS].map((row, i) => (
              <div
                key={i}
                className={`flex items-center justify-between px-[0.88rem] py-[0.66rem] ${i < LEFT_ROWS.length + RIGHT_ROWS.length - 1
                  ? "border-b border-[#E6E7E6]"
                  : ""
                  }`}
              >
                <span className="font-poppins font-medium text-[0.77rem] text-black">
                  {row.label}
                </span>
                <span className="text-[#565656] font-poppins text-[0.77rem] text-right ml-[0.44rem]">
                  {row.value}
                </span>
              </div>
            ))}
        ...
        {/* Feature Cards */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-[0.88rem] mt-[0.44rem]">
      ...
      {/* Action Buttons Row */}
      <div className="flex flex-col sm:flex-row items-center gap-[1.33rem] mt-[1.33rem]">
        {/* Save Draft / Edit */}
        <button className="w-full sm:flex-1 h-[3.11rem] flex items-center justify-center gap-[0.44rem] rounded-[0.44rem] border border-[#F88379] bg-white text-[#F88379] font-poppins font-medium text-[0.88rem] transition-colors hover:bg-red-50">
          <EditIcon />
          Save as Draft
        </button>

        {/* Publish */}
        <button className="w-full sm:flex-1 h-[3.11rem] flex items-center justify-center gap-[0.44rem] rounded-[0.44rem] bg-[#F88379] text-white font-poppins font-semibold text-[0.88rem] transition-transform active:scale-95 shadow-[0_4px_4px_0_rgba(0,0,0,0.25)]">
          Publish Property
          <ArrowRightIcon />
        </button>
      </div>
