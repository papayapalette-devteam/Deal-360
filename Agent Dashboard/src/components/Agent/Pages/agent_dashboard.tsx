...
const navigate =useNavigate()
  ...
  return (
    <div className="space-y-[1.33rem]">

{/* verification */}
      <div className="w-full bg-[#fff7ed] border border-[#ffd6a7]  p-[1.33rem]  items-center justify-between rounded-[0.22rem]">

        <div className="">
          <div className=" flex items-start gap-[0.88rem] ">


            <div className="flex items-center justify-center w-[1rem] h-[1rem] rounded-full border border-red-400 text-red-500">
              <span className="text-[0.77rem] font-semibold">!</span>
            </div>


            <div>
              <h2  className="font-sans font-semibold text-[1.33rem] leading-[120%] tracking-normal">
                Account Verification Required
              </h2>
              <p className="font-poppins font-normal text-[0.88rem] leading-[120%] tracking-normal text-[var(--text-grey,#6C757D)]">
                Complete verification to unlock full platform access and build trust with clients.
              </p>
            </div>
          </div>
        </div>
        <div className="pl-0 sm:pl-[1.55rem] pt-[0.88rem] sm:pt-0">
          <button
          onClick={(()=>navigate("verification"))}
            style={{ border: "2px solid #F88379" }}
            className="flex items-center gap-[0.44rem] 
               px-[0.66rem] py-[0.66rem] 
               rounded-[0.44rem] 
               bg-[#FFD1CD]
               hover:opacity-90 
               transition"
          >
            ...
            <span>
              <svg xmlns="http://www.w3.org/2000/svg" style={{ width: "0.88rem", height: "0.88rem" }} viewBox="0 0 16 16" fill="none">
...
<button onClick={(()=>navigate("add-new-listing"))}
  className="flex items-center justify-center 
             px-[0.83rem] pr-[0.86rem] py-[0.55rem] 
             mt-[0.88rem]
             rounded-[0.44rem] 
             bg-[#7FFFD4]
             font-poppins font-medium text-[0.88rem]
             transition-transform active:scale-95"
>
  + Add New Listing
</button>

<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[1.33rem] pt-[0.66rem]">
  {stats.map((item, index) => {
    ...
    return (
      <div
        key={index}
        className="
          flex flex-col items-start gap-[1.33rem]
          rounded-[0.78rem]
      ...
      >
        ...
        <div className="flex items-start justify-between w-full">
          <p className="text-[#717182] font-manrope text-[0.88rem] font-normal leading-tight">
            {item.title}
          </p>

          <Icon className={`w-[1.11rem] h-[1.11rem] shrink-0 ${item.color}`} />
        </div>

        {/* Value */}
        <h2 className="text-[#F88379] font-manrope text-[1.66rem] font-bold leading-none">
          {item.value}
        </h2>

        {/* Subtitle */}
        <p className="text-[#717182] font-arimo text-[0.66rem] font-normal leading-tight">
          {item.subtitle}
        </p>
      </div>
    );
...
{/* chart */}
   ...
   <div className="grid grid-cols-1 lg:grid-cols-2 gap-[1.33rem] w-full !pt-[1.33rem]">

            {/* Listing Performance */}
            <div className="bg-white rounded-[0.77rem] border border-gray-200 !p-[1.33rem] shadow-sm">
                <h2 className="text-[1rem] text-[#0A0A0A] font-semibold text-gray-800 !mb-[0.22rem] font-manrope">
                    Listing Performance
                </h2>

                <p className="text-[0.77rem] text-[#717182] !mb-[1.33rem] font-manrope">
                    Listings and leads over last 6 months
                </p>

                <div className="h-[17.77rem]">
            ...
            {/* Lead Activity */}
            <div className="bg-white rounded-[0.77rem] border border-gray-200 !p-[1.33rem] shadow-sm">
                <h2 className="text-[1rem] font-semibold text-gray-800 !mb-[0.22rem]">
                    Lead Activity
                </h2>

                <p className="text-[0.77rem] text-gray-500 !mb-[1.33rem]">
        ...
        <div className="w-full max-w-[29rem] 
                ...
                rounded-[0.88rem] 
                bg-white 
                shadow-[0_0_10px_rgba(0,0,0,0.05)] border border-black/5 font-sans">

  <h2 className="text-[1.11rem] font-semibold font-poppins">
    Performance Summary
  </h2>
  ...
  <div className="flex items-center justify-between">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style={{ width: "1.33rem", height: "1.33rem" }} viewBox="0 0 24 24" fill="none">
  <path d="M12.9823 2.76278C12.631 2.48953 12.4553 2.3529 12.2613 2.30038C12.0902 2.25404 11.9098 2.25404 11.7387 2.30038C11.5447 2.3529 11.369 2.48953 11.0177 2.76278L4.23539 8.0379C3.78202 8.39052 3.55534 8.56683 3.39203 8.78764C3.24737 8.98322 3.1396 9.20356 3.07403 9.43783C3 9.7023 3 9.98948 3 10.5638V17.7988C3 18.9189 3 19.4789 3.21799 19.9067C3.40973 20.2831 3.71569 20.589 4.09202 20.7808C4.51984 20.9988 5.0799 20.9988 6.2 20.9988H8.2C8.48003 20.9988 8.62004 20.9988 8.727 20.9443C8.82108 20.8963 8.89757 20.8198 8.9455 20.7258C9 20.6188 9 20.4788 9 20.1988V13.5988C9 13.0387 9 12.7587 9.10899 12.5448C9.20487 12.3566 9.35785 12.2036 9.54601 12.1078C9.75992 11.9988 10.0399 11.9988 10.6 11.9988H13.4C13.9601 11.9988 14.2401 11.9988 14.454 12.1078C14.6422 12.2036 14.7951 12.3566 14.891 12.5448C15 12.7587 15 13.0387 15 13.5988V20.1988C15 20.4788 15 20.6188 15.0545 20.7258C15.1024 20.8198 15.1789 20.8963 15.273 20.9443C15.38 20.9988 15.52 20.9988 15.8 20.9988H17.8C18.9201 20.9988 19.4802 20.9988 19.908 20.7808C20.2843 20.589 20.5903 20.2831 20.782 19.9067C21 19.4789 21 18.9189 21 17.7988V10.5638C21 9.98948 21 9.7023 20.926 9.43783C20.8604 9.20356 20.7526 8.98322 20.608 8.78764C20.4447 8.56683 20.218 8.39052 19.7646 8.03791L12.9823 2.76278Z" fill="#7FFFD4"/>
    ...
    <span className="text-[0.88rem] text-[#717182]">
      Listings
    </span>
    </div>

    <div className="flex items-center gap-[0.44rem]">
      <span className="text-[0.88rem] font-medium text-[#4B4B4B]">
        6 / 10
      </span>

      <svg style={{ width: "1.11rem", height: "1.11rem" }} viewBox="0 0 24 24" fill="none">
        <path
...
<div className="flex gap-[0.44rem]">
  ...
  <path d="M11.9984 9.14062C10.4284 9.14062 9.14844 10.4206 9.14844 12.0006C9.14844 13.5706 10.4284 14.8506 11.9984 14.8506C13.5684 14.8506 14.8584 13.5706 14.8584 12.0006C14.8584 10.4306 13.5684 9.14062 11.9984 9.14062Z" fill="#292D32"/>
    ...
    <span className="text-[0.77rem] text-[#717182]">
      Viewings
    </span>
</div>
    <div className="flex items-center gap-[0.44rem]">
