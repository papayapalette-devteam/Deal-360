...
export default function CancelModal({ onClose, onDowngrade, onFreeze, onCancelAnyway }: CancelModalProps) {
  return (
    <ModalOverlay onClose={onClose}>
      ...
      >
        ...
        {/* Warning box */}
        <div
          className="flex items-start gap-[0.55rem] w-full rounded-lg p-2 overflow-hidden"
        ...
        <button
          onClick={onDowngrade}
          className="w-full flex items-center justify-center py-[0.88rem] px-[1.77rem] rounded-lg font-manrope font-medium text-base transition-opacity hover:opacity-90"
          style={{
        ...
        <button
          onClick={onFreeze}
          className="w-full flex items-center justify-center py-[0.88rem] px-[1.77rem] rounded-lg bg-[var(--form-secondary)] font-manrope font-medium text-base text-black transition-opacity hover:opacity-90"
        >
          Freeze For 1 month
        </button>
