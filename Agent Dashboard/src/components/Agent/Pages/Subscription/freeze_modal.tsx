...
export default function FreezeModal({ onClose, onConfirm, currentPlanPrice }: FreezeModalProps) {
  const [selectedMonth, setSelectedMonth] = useState("March");
  const [selectedDay, setSelectedDay] = useState("1");
  const [selectedYear, setSelectedYear] = useState("2026");
  const [showDatePicker, setShowDatePicker] = useState(false);

  const priceNum = typeof currentPlanPrice === 'number' ? currentPlanPrice : parseFloat(String(currentPlanPrice || "149").replace(/[^0-9.]/g, ''));
  const halfPrice = (priceNum / 2).toFixed(1);
  const fullPrice = priceNum;

  const displayDate = `${selectedMonth} ${selectedDay} ${selectedYear}`;

  const handleDayChange = (e: React.ChangeEvent<HTMLInputElement>) => setSelectedDay(e.target.value);
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <h2
            ...
            style={{ fontSize: "1.33rem", lineHeight: "110%" }}
          >
            Freeze Your Subscription
          </h2>
          <p
            className="font-poppins font-bold text-black"
            style={{ fontSize: "0.88rem", lineHeight: "110%" }}
          >
        ...
        <p
          ...
          style={{ fontSize: "0.66rem", color: "#575757", lineHeight: "110%" }}
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <div
            ...
            style={{ width: "2.66rem", height: "2.66rem", background: "#B4FFE6", padding: "0.66rem" }}
          >
            <SnowflakeIcon />
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p
              ...
              style={{ fontSize: "0.66rem", color: "#A5A5A5", lineHeight: "110%" }}
            >
              AED {fullPrice}
            </p>
          </div>
          ...
          <div className="relative">
            ...
            >
              <span
                ...
                style={{ fontSize: "0.88rem", color: "#4B4B4B", lineHeight: "110%" }}
              >
                {displayDate}
              </span>
              <ChevronDown />
        ...
        <button
          ...
          style={{ padding: "0.88rem 1.77rem", fontSize: "0.88rem", lineHeight: "120%" }}
        >
          Confirm Freeze
        </button>
      </div>
