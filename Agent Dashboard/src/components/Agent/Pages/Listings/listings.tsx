...
function SearchIcon() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "1.11rem", height: "1.11rem" }}>
...
function ShareIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "1.33rem", height: "1.33rem" }}>
...
function BedIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "0.88rem", height: "0.88rem" }}>
...
function PauseIcon() {
  return (
    <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "0.44rem", height: "0.61rem" }}>
...
function PropertyCard({ listing }) {
  return (
    <div className="flex flex-col p-[0.66rem] rounded-[1.33rem] bg-white shadow-[0_4px_6px_rgba(0,0,0,0.10)] gap-[0.88rem] overflow-hidden">

      {/* Image */}
      <div
        className="h-[12.22rem] sm:h-[13.33rem] lg:h-[14.38rem] rounded-[1.33rem] border border-[var(--Colors-for-white-theme-Secondary)] bg-center bg-cover bg-no-repeat p-[0.88rem] flex flex-col justify-start shrink-0"
        style={{ backgroundImage: `url(${listing.image})` }}
      >
        <div className="flex justify-between items-center">

          {/* Badge */}
          <div className="inline-flex px-[0.66rem] py-[0.44rem] justify-center items-center gap-[0.44rem] rounded-full bg-black/70">
            <span className="text-white font-poppins text-[0.66rem] font-medium leading-[120%]">
              {listing.badge}
            </span>
          </div>
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-[0.44rem]">
          <p className="text-[1rem] sm:text-[1.11rem] font-poppins font-normal leading-[110%] text-[var(--form-text)] m-0">
            {listing.title}
          </p>
          <p className="text-[1.11rem] sm:text-[1.33rem] font-poppins font-medium leading-[110%] text-[var(--Colors-for-white-theme-Secondary)] m-0">
            {listing.price}
          </p>
        </div>
  ...
  <div className="flex flex-wrap gap-2">
    ...
    {/* Status */}
    <div className="flex items-center gap-1 px-[0.66rem] py-[0.33rem] rounded-[0.22rem] border border-[var(--Colors-for-white-theme-Secondary)] bg-[rgba(248,131,121,0.10)] whitespace-nowrap min-w-fit">
      ...
      <span className="text-[0.66rem] font-poppins font-normal leading-[150%] text-[var(--Colors-for-white-theme-Secondary)]">
        {listing.status}
      </span>
    </div>
    ...
    {/* Beds */}
    <div className="flex items-center gap-1 px-[0.66rem] py-[0.33rem] rounded-[0.22rem] border border-[var(--neutral-100)] bg-[var(--neutral-50)] whitespace-nowrap min-w-fit">
      <BedIcon />
      <span className="text-[0.66rem] font-poppins font-normal leading-[150%] text-[var(--Colors-for-white-theme-Secondary-text)]">
        {listing.beds}
      </span>
    </div>
    ...
    {/* Baths */}
    <div className="flex items-center gap-[0.22rem] px-[0.66rem] py-[0.33rem] rounded-[0.22rem] border border-[var(--neutral-100)] bg-[var(--neutral-50)] whitespace-nowrap min-w-fit">
      <BathIcon />
      <span className="text-[0.66rem] font-poppins font-normal leading-[150%] text-[var(--Colors-for-white-theme-Secondary-text)]">
        {listing.baths}
      </span>
  ...
  <div className="flex flex-wrap gap-[0.44rem]">
    ...
    <div className="flex items-center gap-[0.22rem] px-[0.66rem] py-[0.33rem] rounded-[0.22rem] border border-[var(--neutral-100)] bg-[var(--neutral-50)] whitespace-nowrap min-w-fit">
      ...
      {/* Description */}
      <p className="text-[0.77rem] sm:text-[0.88rem] font-poppins font-medium leading-[120%] text-[var(--base-black)] m-0">
        {listing.description}
      </p>
      ...
      <div className="flex items-center gap-[0.44rem]">
        <button className="flex flex-1 h-[1.72rem] px-[0.83rem] justify-center items-center gap-[0.44rem] rounded-[0.44rem] border border-[#E6E6E6] bg-white cursor-pointer hover:bg-gray-50">
          <span className="text-[0.83rem] font-manrope font-medium leading-[120%] text-[#565656]">
            Edit
          </span>
        </button>
        <button className="flex w-[2.11rem] h-[1.77rem] justify-center items-center rounded-[0.44rem] border border-black/10 bg-white cursor-pointer shrink-0 hover:bg-gray-50">
          <PauseIcon />
        </button>
        <button className="flex w-[2.11rem] h-[1.77rem] justify-center items-center rounded-[0.44rem] border border-black/10 bg-white cursor-pointer shrink-0 hover:bg-gray-50">
          <DeleteIcon />
...
export default function Listings() {
  ...
  <div className="w-full mx-auto">
    ...
    <div className="flex items-center gap-[0.88rem] mb-[1.33rem]">

      {/* Search */}
      <div className="relative flex-1">

        <div className="absolute left-[0.66rem] top-1/2 -translate-y-1/2 pointer-events-none">
          <SearchIcon />
        </div>
        ...
        <input
          ...
          className="w-full h-[2.55rem] pl-[2.22rem] pr-[0.88rem] rounded-[0.55rem] border border-[#D1D5DC] text-[0.88rem] text-black/50 bg-white outline-none focus:border-[var(--Colors-for-white-theme-Secondary)]"
        />

      </div>

      {/* Filters Button */}
      <button onClick={() => setOpenFilter(true)} className="flex items-center gap-[0.44rem] h-[2.55rem] px-[0.88rem] rounded-[0.55rem] border border-[#D1D5DC] bg-white cursor-pointer hover:opacity-85 shrink-0">
        <FilterIcon />
        <span className="font-arimo text-[0.88rem] text-[#0A0A0A]">
          Filters
        </span>
      </button>
    ...
    {/* ── Tabs ── */}
    <div className="flex w-full items-center gap-[0.44rem] border-b border-[#E6E7E6] mb-[1.33rem] overflow-x-auto scrollbar-hide">
      ...
      {TABS.map((tab, i) => (
        ...
        <button
          ...
          className={`flex p-[0.66rem] whitespace-nowrap border-b-2 transition
          
          ${activeTab === i
            ? "border-[var(--Colors-for-white-theme-Secondary)] text-[var(--Colors-for-white-theme-Secondary)] font-medium text-[0.77rem]"
            : "border-transparent text-[var(--base-black)] font-normal text-[0.77rem]"}
    ...
    {/* ── Listings Grid ── */}
    <div className="grid gap-[1.33rem] grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
