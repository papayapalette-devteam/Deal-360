...
function EmailIcon() {
  return (
    <svg style={{ width: "0.88rem", height: "0.88rem", flexShrink: 0 }} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M13.3359 2.66406H2.66927C1.93289 2.66406 1.33594 3.26102 1.33594 3.9974V11.9974C1.33594 12.7338 1.93289 13.3307 2.66927 13.3307H13.3359C14.0723 13.3307 14.6693 12.7338 14.6693 11.9974V3.9974C14.6693 3.26102 14.0684 2.66406 13.3359 2.66406Z" stroke="#F88379" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
...
function ChevronDownIcon() {
  return (
    <svg style={{ width: "0.88rem", height: "0.88rem", flexShrink: 0, opacity: 0.5 }} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function CircleIcon() {
  return (
    <svg style={{ width: "1.11rem", height: "1.11rem", flexShrink: 0 }} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function ListCard({ lead, onStatusChange }) {
  ...
  return (
    <div
      className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-[0.88rem] p-[1.33rem] rounded-[0.77rem] bg-white"
      style={{ border: "1px solid rgba(0,0,0,0.10)" }}
    >
      {/* Left: Lead Info */}
      <div className="flex flex-col gap-[0.44rem] flex-1 min-w-0">
        <div className="flex items-center gap-[0.66rem] flex-wrap">
          <h3 className="font-bold text-[1.11rem] leading-[1.55rem]" style={{ color: "#0A0A0A", fontFamily: "Manrope, sans-serif" }}>
            {lead.name}
          </h3>
          <span
            className="inline-flex items-center justify-center px-[0.44rem] py-[0.11rem] rounded-[0.44rem] text-[0.66rem] leading-[0.88rem] font-normal"
        ...
        <p className="text-[0.88rem] leading-[1.11rem] font-normal" style={{ color: "#717182", fontFamily: "Manrope, sans-serif" }}>
          {lead.interest}
        </p>

        <div className="flex flex-wrap items-center gap-x-[0.88rem] gap-y-[0.44rem] mt-[0.22rem]">
          <div className="flex items-center gap-[0.44rem]">
            <PhoneIcon />
            <span className="text-[0.77rem] leading-[1.11rem]" style={{ color: "#0A0A0A", fontFamily: "Manrope, sans-serif" }}>{lead.phone}</span>
          </div>
          <div className="flex items-center gap-[0.44rem]">
            <EmailIcon />
            <span className="text-[0.77rem] leading-[1.11rem]" style={{ color: "#0A0A0A", fontFamily: "Manrope, sans-serif" }}>{lead.email}</span>
          </div>
          <div className="flex items-center gap-[0.44rem]">
            <ClockIcon />
            <span className="text-[0.77rem] leading-[1.11rem]" style={{ color: "#0A0A0A", fontFamily: "Manrope, sans-serif" }}>{lead.date}</span>
          </div>
        </div>
      </div>

      {/* Right: Status + Message */}
      <div className="flex flex-col gap-[0.44rem] w-full sm:w-[8.33rem] flex-shrink-0">
        <div className="relative">
          <button
            onClick={() => setDropdownOpen(!dropdownOpen)}
            className="flex items-center justify-between w-full h-[2rem] px-[0.66rem] rounded-[0.44rem] text-[0.77rem] font-normal"
          ...
          {dropdownOpen && (
            <div
              className="absolute right-0 top-full mt-[0.22rem] w-full rounded-[0.44rem] overflow-hidden z-10 shadow-md"
            ...
            >
              {statusOptions.map((opt) => (
                <button
                  ...
                  className="w-full text-left px-[0.66rem] py-[0.44rem] text-[0.77rem] hover:bg-gray-50 transition-colors"
        ...
        <button
          className="flex items-center justify-center gap-[0.66rem] w-full h-[2rem] px-[0.88rem] rounded-[0.44rem] text-[0.77rem] font-normal transition-colors hover:bg-gray-50"
...
function TimelineCard({ lead }) {
  ...
  return (
    <div
      className="flex flex-col gap-[1.66rem] p-[1.33rem] rounded-[0.77rem] bg-white w-full"
      style={{ border: "1px solid rgba(0,0,0,0.10)" }}
    >
      {/* Card Header */}
      <div className="flex items-start justify-between gap-[0.88rem]">
        <div className="flex flex-col gap-[0.22rem]">
          <h3
            className="text-[1.11rem] leading-[1.55rem] font-medium"
            style={{ color: "#0A0A0A", fontFamily: "Manrope, sans-serif" }}
          >
            {lead.name}
          </h3>
          <p
            className="text-[0.88rem] leading-[1.11rem] font-normal"
        ...
        <span
          className="inline-flex items-center justify-center px-[0.44rem] py-[0.11rem] rounded-[0.44rem] text-[0.77rem] leading-[0.88rem] font-normal flex-shrink-0"
          style={{ ...badgeStyle, fontFamily: "Manrope, sans-serif", whiteSpace: "nowrap", minWidth: "3.22rem" }}
        >
          {lead.status}
        </span>
      </div>
      ...
      <div className="flex flex-col gap-[0.88rem]">
        {lead.events.map((event, idx) => (
          <div key={idx} className="flex items-start gap-[0.88rem]">
            {/* Icon + vertical line column */}
            <div className="flex flex-col items-center flex-shrink-0" style={{ width: "1.11rem" }}>
              {event.isLast ? <CheckCircleIcon /> : <CircleIcon />}
              {!event.isLast && (
                <div
                  className="flex-1 mt-[0.22rem]"
                  style={{ width: "0.11rem", minHeight: event.note ? "4rem" : "2.44rem", background: "rgba(0,0,0,0.10)" }}
                />
              )}
            </div>
            ...
            <div className="flex flex-col gap-[0.22rem] flex-1 min-w-0">
              <p
                className="text-[0.88rem] leading-[1.33rem] font-medium"
                style={{ color: "#0A0A0A", fontFamily: "Manrope, sans-serif" }}
              >
                {event.title}
              </p>
              <p
                className="text-[0.77rem] leading-[0.88rem] font-normal"
                style={{ color: "#717182", fontFamily: "Manrope, sans-serif" }}
              >
                {event.date}
              </p>
              {event.note && (
                <div
                  className="mt-[0.22rem] p-[0.66rem] rounded-[0.55rem] w-full"
...
export default function Leads() {
  ...
  return (
    <div
      className="min-h-screen p-[0.88rem] sm:p-[1.33rem] lg:p-[1.77rem]"
      style={{ background: "hsl(var(--background))", fontFamily: "Manrope, sans-serif" }}
    >
      <div className="max-w-[81.77rem] mx-auto flex flex-col gap-[1.77rem]">

        {/* Tab List */}
        <div
          className="flex items-center w-full max-w-[16.22rem] h-[2rem] p-[0.16rem] rounded-[0.77rem]"
          style={{ background: "#FFFFFF" }}
        >
          <button
            onClick={() => setActiveTab("list")}
            className="flex-1 h-[1.61rem] rounded-[0.77rem] text-[0.77rem] font-normal leading-[1.11rem] text-center transition-colors"
            style={{
        ...
        <div className="flex flex-col gap-[0.88rem] w-full">
          ...
          {/* Filter row */}
          <div className="flex items-center gap-[0.88rem] flex-wrap">
            <span
              className="text-[0.77rem] leading-[1.11rem] font-normal whitespace-nowrap"
              style={{ color: "#0A0A0A", fontFamily: "Manrope, sans-serif" }}
            >
              Filter by status:
            </span>
            <div className="relative">
              <button
                ...
                className="flex items-center justify-between gap-[0.44rem] h-[2rem] px-[0.66rem] rounded-[0.44rem] text-[0.77rem] font-normal min-w-[7.77rem]"
              ...
              {filterOpen && (
                <div
                  className="absolute left-0 top-full mt-[0.22rem] min-w-full rounded-[0.44rem] overflow-hidden z-10 shadow-md"
                  style={{ background: "#fff", border: "1px solid rgba(0,0,0,0.10)" }}
                >
                  {filterOptions.map((opt) => (
                    <button
                      ...
                      className="w-full text-left px-[0.66rem] py-[0.44rem] text-[0.77rem] hover:bg-gray-50 transition-colors whitespace-nowrap"
                      style={{ color: "#0A0A0A", fontFamily: "Manrope, sans-serif" }}
                    >
                      {opt}
                    </button>
          ...
          {filteredLeads.length === 0 ? (
            <div
              className="flex items-center justify-center py-[3.55rem] rounded-[0.77rem]"
              style={{ border: "1px solid rgba(0,0,0,0.10)", background: "#fff" }}
            >
              <p className="text-[0.88rem]" style={{ color: "#717182", fontFamily: "Manrope, sans-serif" }}>
