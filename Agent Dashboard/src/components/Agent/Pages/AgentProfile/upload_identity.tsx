    ...
    >
      {!show_selfee && !submission &&(
        <div className="flex flex-col  gap-10 w-full w-full">
          ...
          {/* Header */}
          <div className="flex flex-col items-center gap-[0.88rem] w-full">
          ...
          {/* Cards */}
          <div className="flex flex-col sm:flex-row items-stretch gap-[1.33rem] w-full">

            {/* Passport Card */}
            <div
              onClick={() => setShowPassportUpload("passport")}
              className="flex-1 flex flex-col justify-center items-center gap-[0.55rem] cursor-pointer"
              style={{
                padding: "1.33rem",
            ...
            >
              <div className="flex flex-col items-center gap-[1.33rem] w-full">
                <div className="flex flex-col items-center gap-[0.88rem] w-full">
                  ...
                  <div className="flex flex-col items-center w-full gap-[0.44rem]">
                    <p
                      style={{
                        color: "var(--base-black)",
                        fontFamily: "Poppins, sans-serif",
...
function PassportUpload({ setagent_profile }) {
  ...
  return (
    <div className="w-full flex bg-background p-[0.88rem] sm:p-[1.33rem] md:p-[1.77rem]">
      <div className="w-full">

        <div className="flex flex-col justify-center gap-[1.33rem] p-[1.33rem] rounded-[0.77rem] border-2 border-[#D1D5DC] bg-white w-full">
          ...
          <div className="flex flex-col items-center gap-[1.33rem] w-full">
            ...
            <div className="flex flex-col items-center gap-[0.88rem] w-full">
              ...
              <div className="flex flex-col items-center gap-[0.44rem] w-full">
                <h2
                  className="font-poppins text-[1rem] font-bold text-center"
                ...
                <p
                  className="font-poppins text-[0.77rem] text-center"
            ...
            <label
              ...
              className="flex items-center gap-[0.44rem] px-[0.88rem] rounded-[0.44rem] h-[2.22rem] cursor-pointer"
            ...
            >
              ...
              <span
                className="font-poppins text-[0.77rem]"
      ...
      <div className="w-full">
        ...
        <div className="flex flex-col justify-center gap-[1.33rem] p-[1.33rem] rounded-[0.77rem] border-2 border-[#D1D5DC] bg-white w-full">
          ...
          <div className="flex flex-col items-center gap-[1.33rem] w-full">
            ...
            {/* Icon + Text */}
            <div className="flex flex-col items-center gap-[0.88rem] w-full">
              <div className="flex w-[3.55rem] h-[3.55rem] p-[0.22rem] justify-center items-center rounded-full bg-[#DCFCE7]">
