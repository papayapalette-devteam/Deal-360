const LocationPinIcon = () => (
  <svg style={{ width: "0.66rem", height: "0.66rem" }} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const MintBadge = ({ children }) => (
  <div className="flex h-[1.77rem] items-center justify-center gap-[0.88rem] rounded-[0.44rem] border border-[var(--form-secondary)] px-[0.66rem] overflow-hidden">
    <span className="font-poppins text-[0.77rem] font-normal leading-[1.11rem] text-[#0F172A] whitespace-nowrap">
      {children}
    </span>
  </div>
);
...
const LocationBadge = ({ children }) => (
  <div className="flex items-center gap-[0.44rem] rounded-[0.44rem] px-[1.33rem] py-[0.44rem]" style={{border:"1px solid #F88379"}}>
    <LocationPinIcon />
    <span className="font-poppins text-[0.77rem] font-normal leading-[1.11rem] text-[#0F172A] whitespace-nowrap">
      {children}
    </span>
...
export default function SpecialtiesSection() {
  return (
    <div className="flex flex-col items-start gap-[0.66rem]">
      ...
      <div className="flex flex-col items-start gap-[0.22rem]">
        ...
        <div className="flex items-start gap-[0.44rem] flex-wrap">
