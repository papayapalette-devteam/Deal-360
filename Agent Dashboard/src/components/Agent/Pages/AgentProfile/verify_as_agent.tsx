...
export default function VerifyAgent() {
  ...
  return (
    <div
      className="min-h-screen flex justify-start px-[0.88rem] py-0"
      style={{ background: "hsl(var(--background))" }}
    >
      <div className="w-full flex flex-col items-center gap-[2.66rem]">
        {/* Header */}
        ...
        {/* Cards + Info Section */}
        <div className="flex flex-col gap-[1.33rem] w-full items-stretch">
          {/* Two verification cards */}
          <div className="flex flex-col lg:flex-row gap-[1.33rem] w-full">
            {/* UAE Pass Verification Card */}
            <div
              className="relative flex flex-col rounded-[0.88rem] p-[1.33rem] flex-1 w-full min-w-0"
              style={{
                border: "0.06rem solid #F88379",
                background: "var(--form-bg)",
              }}
            >
              {/* Recommended badge - top right */}
              <div
                className="absolute top-[0.88rem] right-[0.88rem] flex items-center gap-[0.22rem] rounded-[0.22rem] px-[0.44rem] py-[0.22rem]"
              ...
              >
                ...
                <span className="text-[0.66rem] font-normal" style={{ color: "#000" }}>
                  Recommended</span>
              </div>

              {/* Card body */}
              <div className="flex flex-col flex-1 gap-[0.88rem] mt-[0.88rem] justify-between">
                <div className="flex items-start gap-[0.88rem]">
                  ...
                  {/* Content */}
                  <div className="flex flex-col gap-[1.33rem] flex-1 min-w-0">
                    {/* Header */}
                    <div className="flex flex-col gap-[0.44rem]">
                      <div className="flex items-center gap-[0.44rem] flex-wrap">
                        ...
                        <div className="flex items-center justify-center px-[0.44rem] py-[0.11rem] rounded-[0.44rem] overflow-hidden" style={{ border: "0.06rem solid #C0C3C1", background: "#FFF", height: "1.22rem" }}>
                          <span className="text-[0.66rem] font-normal" style={{ color: "#C0C3C1" }}>Instant</span>
                        </div>
                      </div>
            ...
            >
              ...
              >
                ...
                <span className="text-[0.66rem] font-normal" style={{ color: "#000" }}>Recommended</span>
              </div>
              ...
              <div className="flex flex-col flex-1 gap-[0.88rem] mt-[0.88rem] justify-between">
                <div className="flex items-start gap-[0.88rem]">
                  ...
                  <div
                    className="flex-shrink-0 flex items-start justify-center rounded-[0.66rem] pt-[0.66rem] px-[0.66rem]"
                    style={{ width: "2.88rem", height: "2.88rem", background: "var(--form-primary)" }}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                  ...
                  <div className="flex flex-col gap-[1.33rem] flex-1 min-w-0">
                    ...
                    <div className="flex flex-col gap-[0.44rem]">
                      <div className="flex items-center gap-[0.44rem] flex-wrap">
                        ...
                        <div className="flex items-center justify-center px-[0.44rem] py-[0.11rem] rounded-[0.44rem] overflow-hidden" style={{ border: "0.06rem solid #F88379", background: "#F9D6D4", height: "1.33rem" }}>
                          <span className="text-[0.66rem] font-normal" style={{ color: "var(--form-primary)" }}>24-48 hours</span>
                        </div>
                      </div>
                      <p className="text-[0.88rem] font-normal" style={{ color: "var(--text-grey)", lineHeight: "120%" }}>
