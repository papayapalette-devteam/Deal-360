...
export default function ReviewSubmission({agent_profile}) {
  ...
  return (
    <div className=" flex  justify-center p-[0.88rem] sm:p-[1.33rem] lg:p-[1.77rem]" style={{ background: "hsl(var(--background))" }}>
      <div
        className="w-full max-w-[42.66rem] rounded-[0.66rem] border p-[1.33rem] flex flex-col gap-[2.22rem]"
        style={{ background: "#fff", borderColor: "#E6E7E6" }}
      >
        {/* Header */}
        <div className="flex flex-col items-center gap-[0.44rem]">
          <h1
            className="text-[1.33rem] font-medium text-center leading-tight"
            style={{ color: "var(--base-black)", fontFamily: "Poppins, sans-serif" }}
          >
            Review Your Submission
          </h1>
          <p
            className="text-[0.88rem] text-center leading-tight"
        ...
        <div className="flex flex-col gap-6">
          ...
          <div
            className="rounded-[0.88rem] border p-[1.33rem] flex flex-col gap-[1.77rem]"
          ...
          >
            ...
            <div className="flex flex-col gap-[0.44rem]">
              {/* Passport Row */}
              <div
                className="flex items-center justify-between rounded-[0.66rem] px-[1.33rem] py-[0.88rem]"
                style={{ background: "#fff" }}
              >
                <div className="flex items-center gap-4">
                  {/* Icon Container */}
                  <div
                    className="flex items-center justify-center rounded-[0.22rem]"
                    style={{
                      width: "2.11rem",
                      height: "2.11rem",
                      background: "#FFEFEE",
                  ...
                  <div className="flex flex-col gap-[0.44rem]">
                    <span
                      className="text-[0.88rem] font-normal leading-tight"
                      style={{ color: "#101828", fontFamily: "Poppins, sans-serif" }}
                    >
                      Passport
                    </span>
                    <span
                      className="text-[0.77rem] font-normal leading-tight"
          ...
          <div
            className="rounded-[0.88rem] p-[1.33rem] flex flex-col gap-[1.77rem]"
            style={{
              background: "#FFF9F9",
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-[0.44rem] rounded-[0.44rem] py-[0.66rem] px-[0.88rem] text-[0.77rem] font-normal transition-opacity hover:opacity-90 active:opacity-80"
          style={{
