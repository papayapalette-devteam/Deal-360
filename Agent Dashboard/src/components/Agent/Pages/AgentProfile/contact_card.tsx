export default function ContactCard() {
  return (
    <div className="flex flex-col justify-center items-start gap-[0.55rem] flex-1 rounded-[0.78rem] border border-black/10 bg-white p-[1.33rem]">
      <div className="flex flex-col items-start gap-[1.33rem] w-full">
        {/* Title */}
        <h2
          className="w-full text-[#0A0A0A] text-[1rem] font-medium leading-[120%]"
        ...
        {/* Contact rows */}
        <div className="flex flex-col items-start gap-[0.66rem] w-full">
          {/* Phone row */}
          <div className="flex items-center gap-[0.66rem] w-full h-[1.11rem]">
            <svg
              viewBox="0 0 16 16"
              fill="none"
            ...
            <span
              className="text-[#0A0A0A] text-[0.77rem] font-normal leading-[1.11rem]"
              style={{ fontFamily: "'Manrope', sans-serif" }}
            >
              97150 2871704
            </span>
