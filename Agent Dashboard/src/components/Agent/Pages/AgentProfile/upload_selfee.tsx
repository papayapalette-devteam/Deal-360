                ...
                <div className="flex flex-col justify-center gap-[1.33rem] p-[1.33rem] rounded-[0.77rem] border-2 border-[#D1D5DC] bg-white w-full">
                    <div className="flex flex-col items-center gap-[1.33rem] w-full">
                        ...
                        <div className="flex flex-col items-center gap-[0.88rem] w-full">
                            ...
                            <div className="flex flex-col items-center gap-2 w-full">
                                <h2 className="font-poppins text-[1rem] font-bold text-center" style={{ color: "var(--base-black)" }}>
                                    Upload Selfie
                                </h2>
                                <p className="font-poppins text-[0.77rem] text-center" style={{ color: "var(--text-grey)" }}>
                            ...
                            {!selfiePreview ? (
                                ...
                                <>
                                    ...
                                    <label onClick={()=>setsubmission(true)}
                                        className="flex items-center gap-[0.44rem] px-[0.88rem] rounded-[0.44rem] h-[2.22rem] cursor-pointer"
                                        style={{ backgroundColor: "var(--form-secondary)" }} >
                                        <span className="font-poppins text-[0.77rem]"
                                            style={{ color: "var(--form-text-black)" }} >
                                            Next
                                        </span>
                                    </label>
