...
const CheckIcon = () => (
<svg xmlns="http://www.w3.org/2000/svg" style={{ width: "1.11rem", height: "1.11rem" }} viewBox="0 0 20 20" fill="none">
...
const CloseIcon = () => (
  <svg style={{ width: "0.88rem", height: "0.88rem" }} viewBox="0 0 16 16" fill="none">
...
export default function NotificationItem({ notification, onDismiss }) {
  ...
  return (
    ...
    >
      {/* Icon */}
      <div
        className="flex-shrink-0 w-[2.44rem] h-[2.44rem] rounded-[0.55rem] flex items-center justify-center mt-0.5"
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          <h3 className="font-manrope font-medium text-[1rem] leading-[1.5] truncate text-[#101828]">
            {notification.title}
          </h3>

          {notification.unread && (
            <span className="w-[0.44rem] h-[0.44rem] rounded-full bg-[#F88379]" />
          )}
        </div>
      ...
      <button
        ...
        className="flex-shrink-0 w-[1.77rem] h-[1.77rem] flex items-center justify-center rounded-[0.55rem] hover:bg-gray-100 transition"
      >
        <CloseIcon />
      </button>
    </div>
