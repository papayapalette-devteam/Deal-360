  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-200">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3 mb-4 flex-wrap">
          {tabs.map((tab) => (
            <button
              ...
              className="font-arimo text-sm sm:text-base leading-6 px-4 py-2 rounded-[0.55rem] transition-all duration-150 whitespace-nowrap"
              style={{
        ...
        <div
          className="rounded-[0.55rem] border bg-white dark:bg-card shadow-sm mb-6 overflow-hidden"
          style={{ borderColor: "var(--notif-border)" }}
        >
          {filteredNotifications.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 px-4">
              <div
                className="w-[3.55rem] h-[3.55rem] rounded-full flex items-center justify-center mb-4"
                style={{ backgroundColor: "rgba(127, 255, 212, 0.13)" }}
              >
                <svg style={{ width: "1.77rem", height: "1.77rem" }} viewBox="0 0 20 20" fill="none">
                  <path
